# Modified from:
# https://github.com/aleksas/keras-fine-tune-inception/edit/master/fine_tune_inceptionv3.py

'''This script goes along the blog post
"Building powerful image classification models using very little data (i.e. thousands only)"
from blog.keras.io.
'''
...
train_data_dir = os.path.join(current_dir, '..', 'Data_OUT', 'SL', 'train')  #'/tmp/data/train'
validation_data_dir = os.path.join(current_dir, '..', 'Data_OUT', 'SL', 'validation') # '/tmp/data/validation'
